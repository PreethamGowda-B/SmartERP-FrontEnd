...
import { Building2, User, Bell, Shield, Globe, SettingsIcon, Copy, Users } from "lucide-react"
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          ...
          description: "Share this link with employees to join your company",
        })
      } else {
                ...
                <>
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Share this ID with employees to join your company
                    </p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input value={companyData.company_name} readOnly />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Generate a shareable link for employees to join your company
                    </p>
                  </div>
                </>
              ) : (
