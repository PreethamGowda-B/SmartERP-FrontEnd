    ...
    <div className="space-y-4">
      ...
      <div className="flex gap-2 justify-center">
        {Array.from({ length: 6 }).map((_, i) => (
          <motion.input
            ...
            className={`w-11 h-12 text-center text-lg font-bold rounded-xl border bg-white text-gray-900 outline-none transition-all focus:ring-2
              ${error
                ? 'border-red-500 focus:ring-red-500/30'
                : digits[i]
                ? 'border-indigo-500 focus:ring-indigo-500/30'
                : 'border-gray-200 focus:ring-indigo-500/30 focus:border-indigo-500'
              }
      ...
      <div className="text-center">
        <button
          ...
          className="inline-flex items-center gap-1.5 text-sm text-indigo-600 hover:text-indigo-700 disabled:text-gray-400 disabled:cursor-not-allowed transition-colors"
        >
